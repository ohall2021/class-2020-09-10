...
```{r, echo=FALSE}
## use control-option-i to get this cute code bit
ggplot(x, aes(x = mean_age)) + 
  geom_histogram(binwidth = 2, color = "white", fill = "blue") + 
  xlim(min(30), max(55)) +
  labs(title = "Mean Age of Kenya's Voting Population by Polling Station", x = "Mean Age", y = "Number of Polling Stations")
